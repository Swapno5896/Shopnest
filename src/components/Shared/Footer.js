...
const Footer = () => {
    ...
    <div className="flex flex-wrap md:text-left text-center order-first">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a href="/#" className="text-gray-600 hover:text-gray-800">Computers</a>
          </li>
          <li>
            <a href="/#" className="text-gray-600 hover:text-gray-800">Kid's Center</a>
          </li>
          <li>
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <p className="text-gray-500 text-sm mt-2 md:text-left text-center">Enter your email
          <br className="lg:block hidden" />to get more exciting offers
        </p>
      </div>
    </div>
  </div>
  <div className="bg-gray-100">
    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2021 Shopnest —
        <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@Web Intelligence team</a>
      </p>
